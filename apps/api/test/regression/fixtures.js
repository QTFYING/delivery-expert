...
function buildImportTemplatePayload() {
  return {
    ...
    isDefault: true,
    defaultFields: [
      { label: '源订单号', key: 'sourceOrderNo', mapStr: '源订单号', type: 'list' },
      { label: '客户名称', key: 'customer', mapStr: '客户名称', type: 'list' },
      { label: '客户电话', key: 'customerPhone', mapStr: '客户电话', type: 'list' },
      { label: '客户地址', key: 'customerAddress', mapStr: '客户地址', type: 'list' },
      { label: '总金额', key: 'totalAmount', mapStr: '总金额', type: 'list' },
      { label: '下单时间', key: 'orderTime', mapStr: '下单时间', type: 'list' },
      { label: '结算方式', key: 'payType', mapStr: '结算方式', type: 'list' },
      { label: '品名', key: 'skuName', mapStr: '商品名称', type: 'line' },
      { label: '规格', key: 'skuSpec', mapStr: '商品规格', type: 'line' },
      { label: '单位', key: 'unit', mapStr: '单位', type: 'line' },
      { label: '数量', key: 'quantity', mapStr: '数量', type: 'line' },
      { label: '包装规格', key: 'packSpec', mapStr: '包装规格', type: 'line' },
      { label: '单价', key: 'unitPrice', mapStr: '单价', type: 'line' },
      { label: '金额', key: 'lineAmount', mapStr: '商品金额', type: 'line' },
    ],
    customerFields: [],
  };
}
